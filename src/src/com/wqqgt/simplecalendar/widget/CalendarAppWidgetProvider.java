...
package com.wqqgt.simplecalendar.widget;
...
import com.wqqgt.simplecalendar.AllInOneActivity;
import com.wqqgt.simplecalendar.EventInfoActivity;
...
public class CalendarAppWidgetProvider extends AppWidgetProvider {
    ...
    static final String EXTRA_EVENT_IDS = "com.wqqgt.simplecalendar.EXTRA_EVENT_IDS";
    ...
    private void performUpdate(Context context,
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            launchCalendarIntent
                    .setData(Uri.parse("content://com.wqqgt.simplecalendar/time/" + millis));
    ...
    static Intent getLaunchFillInIntent(Context context, long id, long start, long end,
        ...
        String dataString = "content://com.wqqgt.simplecalendar/events";
        if (id != 0) {
