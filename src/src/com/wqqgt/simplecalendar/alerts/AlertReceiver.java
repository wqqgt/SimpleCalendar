 ...
 *    -n "com.wqqgt.simplecalendar/.alerts.AlertReceiver"
 */
public class AlertReceiver extends BroadcastReceiver {
    private static final String TAG = "AlertReceiver";

    private static final String DELETE_ALL_ACTION = "com.wqqgt.simplecalendar.DELETEALL";
    private static final String MAP_ACTION = "com.wqqgt.simplecalendar.MAP";
    private static final String CALL_ACTION = "com.wqqgt.simplecalendar.CALL";
    private static final String MAIL_ACTION = "com.wqqgt.simplecalendar.MAIL";
    ...
    public static final String EVENT_REMINDER_APP_ACTION =
            "com.wqqgt.simplecalendar.EVENT_REMINDER_APP";
